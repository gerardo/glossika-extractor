...
GLOSSIKA-GSR-SENTENCES-PIN=$(OUT)/ENDEZS-F1-sentences-PIN.txt
...
$(GLOSSIKA-GSR-SENTENCES-PIN): $(GLOSSIKA-GSR-SENTENCES) | tmp
	./scripts/PIN-from-sentences.sh $(GLOSSIKA-GSR-SENTENCES) > $@
